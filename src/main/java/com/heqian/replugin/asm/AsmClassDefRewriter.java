...
//                return RewriterUtils.rewriteIterable(new AsmMethodRewriter(rewriters), super.getDirectMethods());
//            }
...
//            if(!AsmMethodRewriter.excludeBroadcast(super.getType())){
//                return RewriterUtils.rewriteIterable(new AsmMethodRewriter(rewriters), super.getVirtualMethods());
//            }
...
//                return RewriterUtils.rewriteIterable(new AsmFieldRewriter(rewriters), super.getStaticFields());
//            }
